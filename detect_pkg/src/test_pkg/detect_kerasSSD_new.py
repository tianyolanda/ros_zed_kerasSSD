#!/usr/bin/env python3
# 1. change the imshow image as the original image 
# 2. not contains NMS
# 3. 6 class model(this model is not good because of highly recall-- recognized all object as person class)
...
def main():
    ...
    img_height = 300 # 272 Height of the input images
    img_width = 300 # 480 Width of the input images
    ...
    while (key != 113) and (not rospy.is_shutdown()):
        ...
        for box in y_pred_thresh[0]:
            ...
            if cls_id == 6:
                ...
                cv2.putText(frame_old, '{:s} | {:.2f}| {:.2f}'.format(class_name,score,distance), (xmin, ymin+2), font, 0.5, (255, 255, 255), thickness=1)
